<template>
  <div class="row m-0">
    <CImg ref="qrLogoUpload" style="height: 100px"
        :src="uploadedLogoSrc" alt="Your QR logo" />
    <div class="ml-3 my-auto" style="position: relative;">
      <input ref="btnUploadLogo" @change="readURL" type="file" accept=".jpg, .png, .svg, .jpeg" style="width: 30px; opacity: 0;"/>
      <CButton
